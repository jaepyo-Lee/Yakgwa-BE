...
public enum VoteErrorCode implements ErrorEnumCode {
    ...
    NOT_VALID_VOTEDATE_EXCEPTION("VE004","모임에 설정된 시간내의 시간이 아닙니다! 다시 투표해주세요"),
    NOT_VALID_VOTE_PLACE_EXCEPTION("VE005","모임에 추가된 후보장소가 아닙니다! 투표장소를 확인해주세요."),
    NOT_VALID_CONFIRM_TIME_EXCEPTION("VE006", "확정가능시간이 지났습니다."),
    NOT_VALID_VOTETIME_EXCEPTION("VE007","투표가능시간이마감되었습니다.");
